...
/**
 * Gap/CFS Feature Page: Precedent analysis at scale
 * Slug: precedent-analysis-at-scale
 * Backend: /api/cf-precedent-analysis-at-scale
 */
...
export default function PrecedentAnalysisAtScalePage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-precedent-analysis-at-scale', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Precedent analysis at scale</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Precedent analysis at scale</p>
