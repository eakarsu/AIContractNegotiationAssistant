...
/**
 * Gap/CFS Feature Page: No deal room/data room management for due diligence.
 * Slug: no-deal-room-data-room-management-for-due-diligence
 * Backend: /api/gap-no-deal-room-data-room-management-for-due-diligence
 */
...
export default function NoDealRoomDataRoomManagementForDueDiligencePage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-deal-room-data-room-management-for-due-diligence', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No deal room/data room management for due diligence.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No deal room/data room management for due diligence.</p>
