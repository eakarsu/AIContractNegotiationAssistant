...
/**
 * Gap/CFS Feature Page: Agentic negotiation modeling
 * Slug: agentic-negotiation-modeling
 * Backend: /api/cf-agentic-negotiation-modeling
 */
...
export default function AgenticNegotiationModelingPage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-negotiation-modeling', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Agentic negotiation modeling</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Agentic negotiation modeling</p>
