...
/**
 * Gap/CFS Feature Page: Regulatory change alerting
 * Slug: regulatory-change-alerting
 * Backend: /api/cf-regulatory-change-alerting
 */
...
export default function RegulatoryChangeAlertingPage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-regulatory-change-alerting', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Regulatory change alerting</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Regulatory change alerting</p>
