...
/**
 * Gap/CFS Feature Page: Benchmarking against market
 * Slug: benchmarking-against-market
 * Backend: /api/cf-benchmarking-against-market
 */
...
export default function BenchmarkingAgainstMarketPage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-benchmarking-against-market', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Benchmarking against market</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Benchmarking against market</p>
