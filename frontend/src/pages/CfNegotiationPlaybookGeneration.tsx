...
/**
 * Gap/CFS Feature Page: Negotiation playbook generation
 * Slug: negotiation-playbook-generation
 * Backend: /api/cf-negotiation-playbook-generation
 */
...
export default function NegotiationPlaybookGenerationPage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-negotiation-playbook-generation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Negotiation playbook generation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Negotiation playbook generation</p>
